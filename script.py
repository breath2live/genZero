...
#strat.addCondition('date', "self.newWeek()")
strat.addCondition('ivrank', "self.indicatorRow('ivrank1') > 50")
strat.addCondition('direction', "self.indicatorRow('ma1') > self.indicatorRow('ma2')")
strat.addCondition('overunder', "self.stockRow('close') > self.indicatorRow('ma1')")
